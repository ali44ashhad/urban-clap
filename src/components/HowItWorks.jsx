  ...
  const steps = [
    {
      ...
      description: "Choose from our wide range of AC services and book online in 2 minutes",
      icon: (
    ...
    },
    {
      ...
      description: "Our certified technician arrives and completes the job professionally",
      icon: (
    ...
    },
    {
      number: "04",
      title: "Enjoy Comfort",
      description: "Sit back and enjoy your perfectly working AC with warranty",
      icon: (
    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">Get your AC serviced in 4 simple steps</p>
        </div>
