...
// export default function HeroModern({ onSearch }) {
...
//                 {popular.map((tag) => (
//                   <button key={tag} onClick={() => setSearchTerm(tag)} className="text-sm px-3 py-1 bg-white/8 rounded-full text-white/90 hover:bg-white/12 transition">
//                     {tag}
//                   </button>
//                 ))}
//               </div>
...
//                 </div>
//                 <div>
//                   <div className="text-white font-bold text-lg">Split AC — Repair & Service</div>
//                   <div className="text-white/80 text-sm">Starts at <span className="font-semibold">₹499</span></div>
//                 </div>
//               </div>
...
//                 <button className="flex-1 px-4 py-2 bg-gradient-to-r from-[#06b6d4] to-[#7c3aed] text-white rounded-2xl font-semibold">Book Now</button>
...
//                 <div className="flex items-center gap-3">
//                   <button onClick={handlePrev} className="px-2 py-1 bg-white/6 rounded-full">◀</button>
//                   <button onClick={handleNext} className="px-2 py-1 bg-white/6 rounded-full">▶</button>
//                 </div>
//                 <div className="text-xs">{current + 1} / {total}</div>
//               </div>
//             </div>
